...
1. 🏷️ Published release [v5.4.1](https://github.com/Snazzah/slash-create/releases/tag/v5.4.1) in [Snazzah/slash-create](https://github.com/Snazzah/slash-create)
2. ❌ Closed PR [#1](https://github.com/Snazzah/slash-create-template/pull/1) in [Snazzah/slash-create-template](https://github.com/Snazzah/slash-create-template)
3. 🗣 Commented on [#1](https://github.com/Snazzah/slash-create-template/issues/1) in [Snazzah/slash-create-template](https://github.com/Snazzah/slash-create-template)
4. 🏷️ Published release [v5.4.0](https://github.com/Snazzah/slash-create/releases/tag/v5.4.0) in [Snazzah/slash-create](https://github.com/Snazzah/slash-create)
5. 💪 Opened PR [#5](https://github.com/CraigChat/webapp/pull/5) in [CraigChat/webapp](https://github.com/CraigChat/webapp)
